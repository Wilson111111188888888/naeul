...
export const metadata: Metadata = {
  ...
  description: "Mentions légales du site naeul.fr : éditeur, hébergeur, personne responsable cosmétique, médiation.",
...
export default function MentionsLegalesPage() {
  return (
    <ContentPage title="Mentions légales" updated="12 juin 2026">
      ...
      <p>
        Le site naeul.fr est édité par <Todo>Prénom NOM</Todo>, entrepreneur individuel exerçant
      ...
      <p>
        ...
        question, écrivez-nous à contact@naeul.fr.
      </p>
    </ContentPage>
  );
}
