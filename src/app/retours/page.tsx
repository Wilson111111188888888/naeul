...
export default function RetoursPage() {
  return (
    ...
    >
      ...
      <ol>
        <li>Écrivez à hello@naeul.com en indiquant votre numéro de commande.</li>
      ...
      <p>
        Si votre commande arrive endommagée, envoyez-nous une photo à hello@naeul.com : nous
